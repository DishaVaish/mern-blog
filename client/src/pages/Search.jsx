...
export default function Search(){
    ...
    return <div className='flex flex-col md:flex-row'>
        ...
        <div className= 'w-full'>
            <h1 className= 'text-3xl font-semibold sm:border-b border-fray-500 p-3 mt-5'> Posts Result: </h1>
            <div className='p-7 flex flex-wrap gap-4'>
                ...
                {
                    showMore && <button className="text-teal-500 text-lg 
